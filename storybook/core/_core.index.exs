...
defmodule VarselWeb.Storybook.Core do
  ...
  def entry("copy_button"), do: [name: "Copy button", icon: {:local, "hero-clipboard-document"}]
  ...
  def entry("summary_panel"), do: [name: "Summary panel", icon: {:local, "hero-chevron-down"}]
