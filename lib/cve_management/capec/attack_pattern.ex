...
defmodule CveManagement.CAPEC.AttackPattern.OkResult do
  @moduledoc false
  use Ash.Type.Enum, values: [:ok]
end

defmodule CveManagement.CAPEC.AttackPattern do
  @moduledoc """
  ...
  alias CveManagement.CAPEC.AttackPattern.OkResult
  alias CveManagement.CAPEC.AttackPatternRelationship
  alias CveManagement.CAPEC.AttackPatternWeakness
  alias CveManagement.CAPEC.CapecMetadata
  ...
  oban do
    scheduled_actions do
      schedule :sync_capec_catalog, "0 5 * * 1",
        ...
        worker_module_name: CveManagement.CAPEC.AttackPattern.SyncCapecCatalogWorker,
        queue: :capec_sync,
        max_attempts: 3

      schedule :sync_capec_catalog_on_boot, "@reboot",
        action: :sync_capec_catalog,
        worker_module_name: CveManagement.CAPEC.AttackPattern.SyncCapecCatalogOnBootWorker,
        queue: :capec_sync,
        max_attempts: 3
    end
  end
  ...
  attributes do
    ...
    attribute :abstraction, CveManagement.CAPEC.AttackPattern.Abstraction do
      allow_nil? false
      public? true
    end

    attribute :status, CveManagement.CAPEC.AttackPattern.Status do
      allow_nil? false
      public? true
    end
    ...
    attribute :likelihood_of_attack, CveManagement.CAPEC.AttackPattern.Likelihood do
      allow_nil? true
      public? true
    end

    attribute :typical_severity, CveManagement.CAPEC.AttackPattern.Severity do
      allow_nil? true
      public? true
    end
