...
defmodule Varsel.CVE.OsvRecord do
  @moduledoc """
  ...
  - `Varsel.CVE.OsvRecord.Notifier` (attached to `CveRecord`) enqueues
  ...
  oban do
    triggers do
      trigger :sync do
        ...
        worker_module_name Varsel.CVE.OsvRecord.SyncWorker
        scheduler_module_name Varsel.CVE.OsvRecord.SyncScheduler
        queue :osv_sync
        max_attempts 3
        scheduler_cron "*/15 * * * *"
    ...
    scheduled_actions do
      schedule :create_missing, "*/15 * * * *",
        ...
        worker_module_name: Varsel.CVE.OsvRecord.CreateMissingWorker,
        queue: :osv_sync,
        max_attempts: 3
    end
  end
