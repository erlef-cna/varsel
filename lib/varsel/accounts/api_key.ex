...
defmodule Varsel.Accounts.ApiKey do
  ...
  policies do
    ...
    # Nothing about an api key is public: a read needs someone to be asking, and
    # the read policy below then narrows to what that someone may see. Scoped to
    # reads so an action no policy names is forbidden by default rather than
