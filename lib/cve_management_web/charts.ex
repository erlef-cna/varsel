...
defmodule CveManagementWeb.Charts do
  @moduledoc """
  ...
  `CveManagementWeb.ChartComponents` renders that data as HEEx `~H` markup.
  ...
  `CveManagementWeb.ChartComponents.cve_activity_chart/1`.
  """
  ...
  `CveManagementWeb.ChartComponents.cwe_donut/1` + `cwe_legend/1`.
  """
