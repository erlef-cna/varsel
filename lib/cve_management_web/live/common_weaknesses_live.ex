...
defmodule CveManagementWeb.CommonWeaknessesLive do
  @moduledoc """
  ...
  import CveManagementWeb.ChartComponents, only: [cwe_donut: 1, cwe_legend: 1]
  import CveManagementWeb.CveView, only: [package_ref: 1]
