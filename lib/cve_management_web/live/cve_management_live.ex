...
defmodule CveManagementWeb.CveManagementLive do
  @moduledoc """
  ...
  JSON lives on `CveManagementWeb.CveManagementEditLive`.
  """
  ...
  # block on CveManagement.CVE.CveRecord), which re-runs the list query so every
